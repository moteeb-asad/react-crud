        ...
        <Container maxW='4xl' bg='white' padding={4} mt={50} mb={50}>
          <Flex alignItems='flex-start' gap='8' >
            <Box>
                ...
                <Text fontSize='sm' mb={2}><strong>State Management :</strong> React Context</Text>
                <Text fontSize='sm' mb={2}><strong>Other :</strong> React Formik, IndexDB For Storage</Text>
            </Box>
          </Flex>
